{{- define "retsamedoc.common.class.podMonitor" -}}
  ...
  {{- if not (empty (dig "controller" "identifier" nil $podMonitorObject)) -}}
    {{- $controllerObject := (include "retsamedoc.common.lib.controller.getByIdentifier" (dict "rootContext" $rootContext "id" $podMonitorObject.controller.identifier) | fromYaml) -}}
...
spec:
  jobLabel: {{ include "retsamedoc.common.lib.podMonitor.field.jobLabel" (dict "ctx" $ctx) | trim }}
  namespaceSelector:
    matchNames:
