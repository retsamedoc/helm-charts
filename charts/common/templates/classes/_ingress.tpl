...
{{- define "retsamedoc.common.class.ingress" -}}
            ...
            backend:
              service:
                ...
                {{ else if .service.identifier -}}
                  {{ $service = (include "retsamedoc.common.lib.service.getByIdentifier" (dict "rootContext" $rootContext "id" .service.identifier) | fromYaml ) -}}
                  {{ if not $service -}}
