...
*/ -}}
{{- define "retsamedoc.common.lib.pod.metadata.annotations" -}}
  ...
  {{- $podAnnotations := (include "retsamedoc.common.lib.pod.getOption" (dict "ctx" $ctx "option" "annotations")) | fromYaml -}}
