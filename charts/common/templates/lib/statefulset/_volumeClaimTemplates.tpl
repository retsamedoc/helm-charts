...
*/}}
{{- define "retsamedoc.common.lib.statefulset.volumeclaimtemplate" -}}
...
*/}}
{{- define "retsamedoc.common.lib.statefulset.volumeclaimtemplates" -}}
  {{- $rootContext := .rootContext -}}
  ...
  {{- range $index, $volumeClaimTemplate := (dig "statefulset" "volumeClaimTemplates" list $statefulsetObject) }}
    {{- $vct := include "retsamedoc.common.lib.statefulset.volumeclaimtemplate" (dict "rootContext" $rootContext "values" $volumeClaimTemplate) -}}
