...
*/}}
{{- define "retsamedoc.common.lib.service.primaryForController" -}}
  ...
  {{- if $enabledServices -}}
    ...
    {{- if not (empty $serviceIdentifier) -}}
      {{- include "retsamedoc.common.lib.service.getByIdentifier" (dict "rootContext" $rootContext "id" $serviceIdentifier) -}}
    {{- end -}}
  {{- end -}}
{{- end -}}
