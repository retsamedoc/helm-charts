...
*/}}
{{- define "retsamedoc.common.lib.networkpolicy.validate" -}}
  ...
  {{- if and ($hasController) (not $hasPodSelector) -}}
    {{- $networkpolicyController := include "retsamedoc.common.lib.controller.getByIdentifier" (dict "rootContext" $rootContext "id" $networkpolicyObject.controller) -}}
