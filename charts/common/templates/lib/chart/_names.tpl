...
{{- define "retsamedoc.common.lib.chart.names.name" -}}
...
*/}}
{{- define "retsamedoc.common.lib.chart.names.fullname" -}}
  {{- $name := include "retsamedoc.common.lib.chart.names.name" . -}}
...
{{- define "retsamedoc.common.lib.chart.names.chart" -}}
