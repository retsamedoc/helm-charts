...
*/}}
{{- define "retsamedoc.common.lib.horizontalPodAutoscaler.validate" -}}
  ...
  {{- $controllerObject := (include "retsamedoc.common.lib.controller.getByIdentifier" (dict "rootContext" $rootContext "id" $hpaObject.controller) | fromYaml) -}}
